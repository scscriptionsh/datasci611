...
from expkg2 import __version__
from expkg2.example import hello
...
def version_callback(value: bool):
    ...
    if value:
        console.print(
            f"[yellow]expkg2[/] version: [bold blue]{__version__}[/]"
        )
        raise typer.Exit()
...
def main(
    ...
    version: bool = typer.Option(
        ...
        is_eager=True,
        help="Prints the version of the expkg2 package.",
    ),
):
