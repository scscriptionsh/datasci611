...
[0m[91mtrying URL 'https://packagemanager.rstudio.com/all/__linux__/focal/latest/src/contrib/matlab_1.0.2.tar.gz'
[0m[91mContent type 'binary/octet-stream' length 171431 bytes (167 KB)
============[0m[91m====[0m[91m=====[0m[91m=====[0m[91m=[0m[91m=====[0m[91m=====[0m[91m====[0m[91m=====[0m[91m====
downloaded 167 KB

[0m[91m* installing *binary* package ‘matlab’ ...
[0m[91m* DONE (matlab)
[0m[91m
